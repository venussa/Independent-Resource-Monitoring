<!-- eslint-disable-->
<template>
    <div style="background: #0a8de2; height: 100%">
      ...
      <div class="col-md-12" style="text-align: center; color: #fff; margin-top: 30px;position: relative; z-index: 999">
          ...
          <p style="font-size: 27px; font-weight: 600;margin-top: 30px;">Independent Monitoring System</p>
          <p style="font-size: 19px;">See your building's TOPO consumption!</p>
